...
import type { CorridorCost, LoadedCctprPlatformDomain, SensibleCorridor, SupportedDomain } from "@stable-io/cctp-sdk-cctpr-definitions";
...
import { genericGasToken, platformClient, v2 } from "@stable-io/cctp-sdk-definitions";
...
export const getCorridorCosts = async <
  N extends Network,
  S extends LoadedCctprPlatformDomain<N, "Evm">,
  D extends SupportedDomain<N>,
> (
