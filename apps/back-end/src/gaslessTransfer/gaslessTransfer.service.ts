...
export interface QuoteRequest {
  readonly sourceDomain: Domain;
  readonly targetDomain: Domain;
  readonly amount: string;
  readonly sender: string;
  readonly recipient: string;
  readonly corridor: string;
  readonly gasDropoff: string;
  readonly permit2PermitRequired: boolean;
}
  ...
  public async quoteGaslessTransfer(
    ...
    const jwtPayload: JwtPayload = {
      ...
      quoteRequest: {
        ...
        gasDropoff: request.gasDropoff.toString(),
        permit2PermitRequired: request.permit2PermitRequired ?? false,
      },
    };
